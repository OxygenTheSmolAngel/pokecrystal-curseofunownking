...
INCBIN "gfx/pokemon/unownking/normal.gbcpal", middle_colors
INCLUDE "gfx/pokemon/unownking/shiny.pal"
INCBIN "gfx/pokemon/gold/normal.gbcpal", middle_colors
INCLUDE "gfx/pokemon/gold/shiny.pal"
