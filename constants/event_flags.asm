...
; Ruins of Alph puzzles
	...
	const EVENT_SOLVED_UNOWNKING_PUZZLE
; Decorations
...
; Exclusive to ROM Hack
	const EVENT_CRACK_IN_WALL
	const EVENT_UNOWNKING_AWAKENING
	const EVENT_UNOWNKING_ROADBLOCKS
	const EVENT_BROKEN_PC
	const EVENT_TALKED_TO_MOM_AFTER_UNOWNKING_KILL
	const EVENT_UNKI_TALKED_TO_FUJI
	const EVENT_TALKED_TO_OXYGEN
	const EVENT_GOT_UNOWNKING
