...
CeladonMansionRoofPharmacistScript:
	faceplayer
	opentext
...
CeladonMansionRoof_MapEvents:
	...
	object_event  3,  1, SPRITE_PHARMACIST, SPRITEMOVEDATA_STANDING_UP, 0, 2, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeladonMansionRoofPharmacistScript, -1
