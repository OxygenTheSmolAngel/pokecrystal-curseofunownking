...
RuinsOfAlphOutside_MapEvents:
	...
	def_object_events
	object_event  4, 20, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerPsychicNathan, EVENT_UNOWNKING_AWAKENING
	...
	object_event 14,  8, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadblockRockScript, EVENT_UNOWNKING_ROADBLOCKS
	object_event 16, 34, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadblockRockScript, EVENT_UNOWNKING_ROADBLOCKS
	object_event  6, 28, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadblockRockScript, EVENT_UNOWNKING_ROADBLOCKS
	object_event  2, 30, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadblockRockScript, EVENT_UNOWNKING_ROADBLOCKS
	object_event 14,  8, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadblockRockScript, EVENT_UNOWNKING_ROADBLOCKS
	object_event  6, 20, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadblockRockScript, EVENT_UNOWNKING_ROADBLOCKS
	object_event  2, 18, SPRITE_ROCK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RoadblockRockScript, EVENT_UNOWNKING_ROADBLOCKS